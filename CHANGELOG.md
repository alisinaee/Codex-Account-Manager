...
This file mirrors the user-visible release stream for GitHub readers. GitHub Releases should be the primary release surface, while this file and [docs/release-notes.md](docs/release-notes.md) keep the full in-repo history.
...
- Added trust and maintenance surfaces including `LICENSE`, `SECURITY.md`, `CONTRIBUTING.md`, issue templates, and a pull request template.
- Added a lightweight demo GIF asset for the README and linked readers to GitHub Releases as the primary release surface.
